...
// ChangeForbidden returns a *Error indicating field change is disallowed*. This is used to signal
// callers must also include errors if the new value is invalid independent of the current value.
